...
const BirthdayBanner = ({ sharedValue, updateSharedValue }) => {
    ...
    useEffect(() => {
        const fetchRsvps = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_SERVER_URI}/rsvps`);
    ...
    return (
        <div className="birthday-banner">
            ...
            <img id="flicker" src="northerFlicker.png" alt="birdy30-flicker" border="0" style="transform: scaleY(-1); display: block;"/>
            </div>
